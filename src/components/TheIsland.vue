...
<template>
  ...
  <a-entity gltf-model="#physic-room" position="-7 200.1 0" scale="15 15 15">
    <!--  lumière-->
    <a-entity
      light="type: ambient; color: #EEE; intensity: 1"
      position="-1 1 0"
    ></a-entity>
    ...
    <a-entity>
      <a-plane
        position="1.907 0.15 .1"
        geometry="width: 0.4; height: 0.06"
        material="color: #B2885E; opacity: 0.8"
        look-at=""
        center
      ></a-plane>
      <a-text
        align="center"
        value="Tom Nook : Thanks for helping me"
        position="1.907 0.15 .1"
        color="white"
        scale="0.1 0.1 0.1 "
        look-at=""
